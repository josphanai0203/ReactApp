    ...
    return (
        <header className={clsx(styles.wrapper)}>
            <div className={clsx(styles.content)}>
                ...
                <Tippy
                    hideOnClick={true}
                    visible={resultSearch > 0}
                    interactive
                    render={(attrs) => (
                        <div className={styles.box} tabIndex="-1" {...attrs}>
                            <PopperWrapper>
                                <h4 className={clsx(styles.searchLabel)}>Accounts</h4>
                                <AccountItem />
                                <AccountItem />
                                <AccountItem />
                                <AccountItem />
                ...
                >
                    <div className={clsx(styles.search)}>
                        <input placeholder="Search Music and Video" spellCheck={false} />
                        <button className={clsx(styles.clear)}>
                            <FontAwesomeIcon icon={faCircleXmark} />
                        </button>
                        <FontAwesomeIcon icon={faSpinner} className={clsx(styles.loading)} />
                        <span></span>
                        <button className={clsx(styles.iconSearch)}>
